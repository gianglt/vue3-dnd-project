...
// Import Store
import { useProcessStore } from '@/stores/refProcessStore'; // Đường dẫn tới store

// Import các component con (giữ nguyên)
import DrawProcessRectangle from './RefRectangle.vue';
import DrawProcessContextMenu from './RefContextMenu.vue';
import DynamicRefProcessEditFormModal from './RefEditForm.vue';
import DrawProcessSaveLoadControls from './RefSaveLoadControls.vue';
import DataEntryModal from './RefDataEntryModal.vue';

// Import types và paletteItems (có thể không cần nếu không dùng trực tiếp ở đây nữa)
import { paletteItems } from '../../data/refProcessSchemas.js'; // Vẫn cần cho palette
